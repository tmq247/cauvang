...
from SANKIXD.plugins.tools.pretenderdb import impo_off, impo_on, check_pretender, add_userdata, get_userdata, usr_data
...
ROY = [
    [
        InlineKeyboardButton(
            text="ᴀᴅᴅ ᴍᴇ",
            url=f"https://t.me/muoimuoiamnhac_Bot?startgroup=true"),
        InlineKeyboardButton(text="ᴜᴘᴅᴀᴛᴇ", url=f"https://t.me/muoimuoimusicbot")
    ],
]
...
@app.on_message(filters.group & filters.command("sendbot") & ~filters.bot & ~filters.via_bot)
